...
public class CSVOperationsAppliances extends TestBaseNew {
	...
	public CSVOperationsAppliances () {
		PageFactory.initElements(driver, this);
	}

	// ACTIONS
	public void Appcsvoperation() throws InterruptedException {
		Actions action = new Actions(driver);
		Thread.sleep(3000);
		action.moveToElement(driver.findElement(By.xpath("//button[text()='CSV Options']"))).build().perform();
		CSV.click();
	}
	public void App_VersionHistory() throws InterruptedException {
		Actions action = new Actions(driver);
		Thread.sleep(3000);
	...
	public void Appscroll() throws InterruptedException {
	...
	public void App_Downloadcsv() throws InterruptedException {
		CSV.click();
		Thread.sleep(2000);
		Actions action = new Actions(driver);
		Thread.sleep(3000);
	...
	public void Appuploadfile() throws InterruptedException {
		CSV.click();
		Thread.sleep(3000);
